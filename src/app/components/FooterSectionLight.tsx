...
export default function FooterSectionLight() {
    return (
        <footer className="footer-section-4 section-padding section-bg pb-0 pt-0">
            <div className="shape-1 d-none d-xxl-block float-bob-x">
                <img src="/assets/img/home-4/footer-shape-1.png" alt="img" />
            </div>
            <div className="shape-2 d-none d-xxl-block float-bob-y">
                <img src="/assets/img/home-4/footer-shape-2.png" alt="img" />
            </div>
            <div className="container">
                <div className="footer-widget-top-4 wow fadeInUp">
